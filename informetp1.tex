...
\subsubsection{Función Vecinos}

Se decidio que para esta función solo se utilizaría una variable ``v'' que iría acumulando la cantidad de vecinos de la casilla enviada.
...
Ambos dejan un programa compilado llamado \textbf{conway} que se puede invocar como dice el enunciado.
...
Sabemos que en las posiciones 16,20,24,28 y 32 tenemos los 5 parámetros de la función
